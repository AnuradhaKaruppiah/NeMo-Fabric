...
ADAPTER_PUBLISH_WORKFLOW = (
    REPO_ROOT / ".github/workflows/publish_typescript_adapters.yml"
)
...
def test_contract_publisher_only_triggers_for_public_release_channels():
